...
namespace WebsiteBanGiayDep23.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            ViewBag.ProductCategory = new SelectList(db.ProductCatgories.ToList(), "ID", "Title");
            return View();
        }
        ...
        public ActionResult Add(Product model, List<string> Images, List<int> rDefault)
        {
            if (ModelState.IsValid)
            {
                ...
                if (string.IsNullOrEmpty(model.Alias))
                    model.Alias = WebsiteBanGiayDep23.Models.Common.Filter.FilterChar(model.Title);
        ...
        public ActionResult Delete(int id)
        {
            ...
            if (item != null)
            {
                ...
                if (checkImg != null)
                {
                    ...
                    {
                        db.ProductImage.Remove(img); //xóa ảnh trước
                        db.SaveChanges();
                    }
                }
